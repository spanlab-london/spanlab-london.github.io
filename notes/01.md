Help me update research lab website of SPAN lab (at spanlab-london.github.io) too. 

First, read README file carefully:
...
Looks like I need to switch ruby:
```zsh
➜  spanlab-london.github.io git:(main) bundle exec jekyll serve --livereload
rbenv: version `3.2.2' is not installed (set by /Users/marko/dev/spanlab-london.github.io/.ruby-version)
➜  spanlab-london.github.io git:(main)
```
